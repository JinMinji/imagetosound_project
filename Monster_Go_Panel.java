...
public class Monster_Go_Panel extends JFrame {
	JPanel contentPane;
	JPanel menuPanel;
	JPanel centerPanel;
	JPanel character;
	...
	ImageIcon[] originIcon = new ImageIcon[] {
			new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\monster1.png"),
			new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\monster2.png"),
			new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\monster3.png"),
			new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\monster4.png"),
			new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\monster5.png")
	};
...
/*	
	public void paint (Graphics g1){
		   ...
		   ImageIcon originIcon = new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\HW\\src\\bug_catch\\Grassroots.jpg");
